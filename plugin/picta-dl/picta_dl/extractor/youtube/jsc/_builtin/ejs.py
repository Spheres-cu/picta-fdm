...
from picta_dl.dependencies import yt_dlp_ejs as _has_ejs
from picta_dl.extractor.youtube.jsc._builtin import vendor
...
from picta_dl.extractor.youtube.pot._provider import configuration_arg
from picta_dl.extractor.youtube.pot.provider import provider_bug_report_message
from picta_dl.utils import version_tuple
from picta_dl.utils._jsruntime import JsRuntimeInfo
...
if TYPE_CHECKING:
    ...
    from picta_dl.extractor.youtube.jsc.provider import JsChallengeRequest
