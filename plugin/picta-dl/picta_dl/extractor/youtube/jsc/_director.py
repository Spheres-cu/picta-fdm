...
from picta_dl.extractor.youtube.jsc._builtin.ejs import _EJS_WIKI_URL
from picta_dl.extractor.youtube.jsc._registry import (
    _jsc_preferences,
    _jsc_providers,
)
from picta_dl.extractor.youtube.jsc.provider import (
    JsChallengeProvider,
...
from picta_dl.extractor.youtube.pot._director import YoutubeIEContentProviderLogger, provider_display_list
from picta_dl.extractor.youtube.pot._provider import (
    IEContentProviderLogger,
)
from picta_dl.extractor.youtube.pot.provider import (
...
if typing.TYPE_CHECKING:
    ...
    from picta_dl.extractor.youtube.jsc._builtin.ejs import _SkippedComponent
    from picta_dl.extractor.youtube.jsc.provider import Preference as JsChallengePreference
