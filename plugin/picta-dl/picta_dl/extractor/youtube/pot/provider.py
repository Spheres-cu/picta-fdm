...
from picta_dl.cookies import YoutubeDLCookieJar
...
from picta_dl.extractor.youtube.pot._registry import _pot_providers, _ptp_preferences
from picta_dl.networking import Request, Response
from picta_dl.utils import traverse_obj
from picta_dl.utils.networking import HTTPHeaderDict
...
class PoTokenProvider(IEContentProvider, abc.ABC, suffix='PTP'):
    ...
    # For a list of WebPO client names, see picta_dl.extractor.youtube.pot.utils.WEBPO_CLIENTS.
    # Also see picta_dl.extractor.youtube._base.INNERTUBE_CLIENTS
