...
from picta_dl.extractor import import_extractors
from picta_dl.extractor.common import InfoExtractor, SearchInfoExtractor
from picta_dl.globals import extractors
...
def main():
    ...
    lazy_extractors_filename = get_filename_args(default_outfile='picta_dl/extractor/lazy_extractors.py')
